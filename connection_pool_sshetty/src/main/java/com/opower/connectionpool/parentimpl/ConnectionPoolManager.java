...
public class ConnectionPoolManager implements ConnectionPool{
	...
	/*
	 * (non-Javadoc)
	 * @see com.opower.connectionpool.ConnectionPool#getConnection(java.lang.String)
	...
	/*
	 * (non-Javadoc)
	 * @see com.opower.connectionpool.ConnectionPool#releaseConnection(java.sql.Connection, java.lang.String)
	...
	/*
	 * (non-Javadoc)
	 * @see com.opower.connectionpool.ConnectionPool#purgeConnectionPool(java.lang.String)
	...
	/*
	 * (non-Javadoc)
	 * @see com.opower.connectionpool.ConnectionPool#getStatistics(java.lang.String)
	...
	/*
	 * (non-Javadoc)
	 * @see com.opower.connectionpool.ConnectionPool#createConnection(java.lang.String)
	...
	/*
	 * (non-Javadoc)
	 * @see com.opower.connectionpool.ConnectionPool#createConnectionPools(java.util.List)
